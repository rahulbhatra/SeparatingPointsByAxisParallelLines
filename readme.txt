...
c. Number of files should be correct and should be in the following format:-
...
d. Output file will be present in the format of "local_solution01" where 01 represents file number.
